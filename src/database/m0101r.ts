    ...
    tests: [
      {
        ...
        items: [
          {
            id: 1,
            fields: compile(`What textbox("(1)";"does") the phrase 'the great British seaside' bring to mind? Most people, if asked
          ...
          {
            id: 2,
            fields: compile(`After years of neglect, Blackpool has to work hard to catch textbox("(10)";"up") with foreign destinations,
