const course = {
  ...
  **«Macmillan Exam Skills For Russia: Grammar and Vocabulary»** состоит в том, чтобы помочь
  учащимся подготовиться к сдаче экзаменов по английскому языку в формате ЕГЭ и на уровень B2
  (Vantage) общеевропейской системы оценки владения иностранным языком (Common European
  Framework Scale). Пособие включает теоретический материал и практические упражнения по тем
  разделам лексики и грамматики, которые входят во все основные части экзамена на уровень B2
  ...
  Грамматический раздел начинается с теоретической части (две первых страницы каждого раздела),
  ...
  соответствующие требованиям ЕГЭ и экзамена на уровень B2. Каждый раздел начинается с
  ...
  Лексические упражнения различной сложности в формате ЕГЭ и экзамена на уровень B2
